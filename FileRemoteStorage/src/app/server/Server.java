...
public class Server {
    ...
    private void routeToHandler(Transport transport, Message request) {
        (switch (request) {
            ...
            ase DeleteFileRequest req -> new DeleteFileHandler(transport, io, fileSystemService, sessionService);
            case DirectoryUploadRequest req -> new DirectoryUploadHandler(transport, io, sessionService, fileSystemService);
